In-plugin branding assets — KennelFlow Boarding
=================================================

Plugin slug: kennelflow-boarding
...
Optional slug-prefixed copies (when sharing assets across repos):
  kennelflow-boarding-logo.svg
  kennelflow-boarding-icon-128.png

Usage in PHP (example)
----------------------
  KENNELFLOW_BOARDING_PLUGIN_URL . 'assets/images/branding/icon-32.png'
